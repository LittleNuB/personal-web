...
def build(archive, output, base):
    ...
    for name in ('index.html', 'styles.css', 'preview.css', 'assets/homymate-home-preview.png', 'assets/trainpal-home-preview.png', 'app.js', 'assets/profile-chibi-lightblue-v5.png', 'assets/trainpal-gentle-idle.webp', 'assets/bili-bill-dashboard.png', 'assets/zhiyin-card.png'):
        target = output / name
